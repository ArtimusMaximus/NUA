...
export default function Dashboard()
{
    ...
    return (
        <>
            <h1 className="text-center py-24 text-4xl font-bold italic">Dashboard</h1>
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 mx-auto grid-flow-row grid-rows-4">
